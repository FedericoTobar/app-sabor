                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <button className="btn btn-primary w-100 mb-2">
                                <span className="fa fa-google me-2"></span>Registro con Google
                            </button>
                            <button className="btn btn-primary w-100 mb-2">
                                <span className="fa fa-facebook me-2"></span>Registro con Facebook
                            </button>
                            <form>
                            <div className="mb-3">
                                ...
                                <button type="submit" className="btn btn-outline-primary w-100 mt-5">Registrar</button>
                            </form>
                        </div>
